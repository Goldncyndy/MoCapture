...
class CaptureListViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        collectionView.register(CaptureListCollectionViewCell.self, forCellWithReuseIdentifier: CaptureListCollectionViewCell.identifier)
    ...
    @objc private func addNewEventButtonTapped() {
            let addEventVC = AddNewCaptureViewController()
...
extension CaptureListViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate {
   ...
   func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: CaptureListCollectionViewCell.identifier, for: indexPath) as? CaptureListCollectionViewCell else {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let eventDetailVC = CaptureDetailsViewController()
...
extension CaptureListViewController: CaptureListCollectionViewCellDelegate {
    
    func captureListCollectionViewCell(_ cell: CaptureListCollectionViewCell, didTapDeleteFor event: EventsModel) {
